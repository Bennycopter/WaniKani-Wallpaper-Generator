...
<p>If you have multiple monitors and want a different wallpaper on each, set up a different device on this site for each monitor and make a custom script for yourself (see the examples below).  Make sure to adjust the &d=1 and &d=2 as necessary to match the screen/device numbers.</p>
